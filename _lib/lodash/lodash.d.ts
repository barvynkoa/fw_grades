...
declare module _ {
	...
	interface LoDashStatic {
		 ...
		 * @see _.zipObject
		 */
		object<TValues, TResult extends {}>(props: List<StringRepresentable> | List<List<any>>,
		                                    values?: List<TValues>): TResult;

		/**
		 * @see _.zipObject
		 */
		object<TResult extends {}>(props: List<StringRepresentable> | List<List<any>>,
		                           values?: List<any>): TResult;

		/**
		 * @see _.zipObject
		 */
		object(props: List<StringRepresentable> | List<List<any>>,
	...
	interface LoDashStatic {
		 ...
		 * @return The index at which value should be inserted into array.
		 **/
		sortedLastIndex<T, TSort>(array: Array<T>,
		                          value: T,
		                          callback?: (x: T) => TSort,
		                          thisArg?: any): number;
		 ...
		 * @param pluckValue the _.pluck style callback
		 **/
		sortedLastIndex<T>(array: Array<T>,
		                   value: T,
		                   pluckValue: string): number;
		 ...
		 * @param pluckValue the _.where style callback
		 **/
		sortedLastIndex<W, T>(array: Array<T>,
		                      value: T,
		                      whereValue: W): number;
	...
	interface LoDashStatic {
		 ...
		 * @see _.every
		 */
		all<T>(collection: List<T> | Dictionary<T>,
		       predicate?: string,
		       thisArg?: any): boolean;
		 ...
		 * @see _.every
		 */
		all<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.every
		 */
		all(predicate?: ListIterator<T, boolean>,
		    thisArg?: any): boolean;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.every
		 */
		all<TResult>(predicate?: ListIterator<TResult, boolean> | DictionaryIterator<TResult, boolean>,
		             thisArg?: any): boolean;
	...
	interface LoDashExplicitArrayWrapper<T> {
		 ...
		 */
		all(predicate?: ListIterator<T, boolean>,
		    thisArg?: any): LoDashExplicitWrapper<boolean>;
	...
	interface LoDashStatic {
		 ...
		 * @see _.some
		 */
		any<T>(collection: List<T> | Dictionary<T>,
		       predicate?: string,
		       thisArg?: any): boolean;
		 ...
		 * @see _.some
		 */
		any<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
		                           predicate?: TObject): boolean;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
		 * @see _.some
		 */
		any(predicate?: ListIterator<T, boolean>,
		    thisArg?: any): boolean;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.some
		 */
		any<TResult>(predicate?: ListIterator<TResult, boolean> | DictionaryIterator<TResult, boolean>,
		             thisArg?: any): boolean;
	...
	interface LoDashStatic {
		 ...
		 * @see _.map
		 */
		collect<T, TResult>(collection: List<T> | Dictionary<T>,
		                    iteratee?: string): TResult[];

		/**
		 * @see _.map
		 */
		collect<T, TObject extends {}>(collection: List<T> | Dictionary<T>,
	...
	interface LoDashStatic {
		 ...
		 * @see _.includes
		 */
		contains<T>(collection: List<T> | Dictionary<T>,
		            target: T,
	...
	interface LoDashStatic {
		 ...
		 * @see _.find
		 */
		detect<T>(collection: List<T> | Dictionary<T>,
		          predicate?: string,
		          thisArg?: any): T;
		 ...
		 * @see _.find
		 */
		detect<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
		                              predicate?: TObject): T;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
		 * @see _.find
		 */
		detect(predicate?: ListIterator<T, boolean>,
		       thisArg?: any): T;

		/**
		 * @see _.find
		 */
		detect(predicate?: string,
		       thisArg?: any): T;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.find
		 */
		detect<TResult>(predicate?: ListIterator<TResult, boolean> | DictionaryIterator<TResult, boolean>,
		                thisArg?: any): TResult;

		/**
		 * @see _.find
		 */
		detect<TResult>(predicate?: string,
		                thisArg?: any): TResult;
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.forEach
		 */
		each(iteratee: StringIterator<any>,
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.forEachRight
		 */
		eachRight(iteratee: StringIterator<any>,
		          thisArg?: any): LoDashImplicitWrapper<string>;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
	...
	interface LoDashStatic {
		 ...
		 * @see _.every
		 */
		every<T>(collection: List<T> | Dictionary<T>,
		         predicate?: string,
		         thisArg?: any): boolean;
		 ...
		 * @see _.every
		 */
		every<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
		                             predicate?: TObject): boolean;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
		 * @see _.every
		 */
		every(predicate?: ListIterator<T, boolean>,
		      thisArg?: any): boolean;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.every
		 */
		every<TResult>(predicate?: ListIterator<TResult, boolean> | DictionaryIterator<TResult, boolean>,
		               thisArg?: any): boolean;
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.forEach
		 */
		forEach(iteratee: StringIterator<any>,
		        thisArg?: any): LoDashImplicitWrapper<string>;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
	...
	interface LoDashStatic {
		 ...
		 * @param thisArg The this binding of callback.
		 */
		forEachRight(collection: string,
		             iteratee?: StringIterator<any>,
		             thisArg?: any): string;
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.forEachRight
		 */
		forEachRight(iteratee: StringIterator<any>,
		             thisArg?: any): LoDashImplicitWrapper<string>;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.groupBy
		 **/
		groupBy(pluckValue: string): _.LoDashImplicitObjectWrapper<_.Dictionary<T[]>>;

		/**
		 * @see _.groupBy
		 **/
		groupBy<W>(whereValue: W): _.LoDashImplicitObjectWrapper<_.Dictionary<T[]>>;
	}
	interface LoDashImplicitObjectWrapper<T> {
		/**
		 * @see _.groupBy
		 ...
		 * @see _.groupBy
		 **/
		groupBy<TValue>(pluckValue: string): _.LoDashImplicitObjectWrapper<_.Dictionary<TValue[]>>;

		/**
		 * @see _.groupBy
		 **/
		groupBy<W, TValue>(whereValue: W): _.LoDashImplicitObjectWrapper<_.Dictionary<TValue[]>>;
	}
	//_.include
	interface LoDashStatic {
		/**
		 * @see _.includes
		 */
		include<T>(collection: List<T> | Dictionary<T>,
		           target: T,
		           fromIndex?: number): boolean;
	...
	interface LoDashStatic {
		 ...
		 * @see _.map
		 */
		map<T, TResult>(collection: List<T> | Dictionary<T>,
		                iteratee?: string): TResult[];

		/**
		 * @see _.map
		 */
		map<T, TObject extends {}>(collection: List<T> | Dictionary<T>,
		                           iteratee?: TObject): boolean[];
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
	...
	interface LoDashStatic {
		 ...
		 */
		pluck<T extends {}>(collection: List<T> | Dictionary<T>,
		                    path: StringRepresentable | StringRepresentable[]): any[];

		/**
		 * @see _.pluck
		 */
		pluck<T extends {}, TResult>(collection: List<T> | Dictionary<T>,
	...
	interface LoDashStatic {
		 ...
		 * @see _.filter
		 */
		select<T>(collection: List<T> | Dictionary<T>,
		          predicate: string,
		          thisArg?: any): T[];
		 ...
		 * @see _.filter
		 */
		select<W extends {}, T>(collection: List<T> | Dictionary<T>,
		                        predicate: W): T[];
	}
	interface LoDashImplicitWrapper<T> {
		/**
		 * @see _.filter
		 */
		select(predicate?: StringIterator<boolean>,
		       thisArg?: any): LoDashImplicitArrayWrapper<string>;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
		 * @see _.filter
		 */
		select(predicate: ListIterator<T, boolean>,
		       thisArg?: any): LoDashImplicitArrayWrapper<T>;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.filter
		 */
		select<T>(predicate: ListIterator<T, boolean> | DictionaryIterator<T, boolean>,
		          thisArg?: any): LoDashImplicitArrayWrapper<T>;

		/**
		 * @see _.filter
		 */
		select<T>(predicate: string,
		          thisArg?: any): LoDashImplicitArrayWrapper<T>;
	...
	interface LoDashStatic {
		 ...
		 * @see _.some
		 */
		some<T>(collection: List<T> | Dictionary<T>,
		        predicate?: string,
		        thisArg?: any): boolean;
		 ...
		 * @see _.some
		 */
		some<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
		                            predicate?: TObject): boolean;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
		 * @see _.some
		 */
		some(predicate?: ListIterator<T, boolean>,
		     thisArg?: any): boolean;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.some
		 */
		some<TResult>(predicate?: ListIterator<TResult, boolean> | DictionaryIterator<TResult, boolean>,
		              thisArg?: any): boolean;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.sortBy
		 */
		sortBy<T, TSort>(iteratee?: ListIterator<T, TSort> | DictionaryIterator<T, TSort>,
		                 thisArg?: any): LoDashImplicitArrayWrapper<T>;
	...
	interface LoDashStatic {
		 ...
		 * @return Returns the new curried function.
		 */
		curry<T1, T2, T3, T4, T5, R>(func: (t1: T1, t2: T2, t3: T3, t4: T4,
		                                    t5: T5) => R): CurriedFunction5<T1, T2, T3, T4, T5, R>;
		/**
		 * Creates a function that accepts one or more arguments of func that when called either invokes func returning
		 * its result, if all func arguments have been provided, or returns a function that accepts one or more of the
		 * remaining func arguments, and so on. The arity of func may be specified if func.length is not sufficient.
	...
	interface LoDashStatic {
		 ...
		 * @return Returns the new curried function.
		 */
		curryRight<T1, T2, T3, T4, T5, R>(func: (t1: T1, t2: T2, t3: T3, t4: T4,
		                                         t5: T5) => R): CurriedFunction5<T5, T4, T3, T2, T1, R>;
		/**
		 * This method is like _.curry except that arguments are applied to func in the manner of _.partialRight
		 * instead of _.partial.
		 * @param func The function to curry.
	...
	interface Partial {
		...
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, plc1: PH, plc2: PH,
		                    arg3: T3): Function3<T1, T2, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, plc2: PH,
		                    arg3: T3): Function2<T2, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, plc1: PH, arg2: T2,
		                    arg3: T3): Function2<T1, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, arg2: T2,
		                    arg3: T3): Function1<T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, plc1: PH, plc2: PH, plc3: PH,
		                    arg4: T4): Function3<T1, T2, T3, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, plc2: PH, plc3: PH,
		                    arg4: T4): Function2<T2, T3, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, plc1: PH, arg2: T2, plc3: PH,
		                    arg4: T4): Function2<T1, T3, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, arg2: T2, plc3: PH,
		                    arg4: T4): Function1<T3, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, plc1: PH, plc2: PH, arg3: T3,
		                    arg4: T4): Function2<T1, T2, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, plc2: PH, arg3: T3,
		                    arg4: T4): Function1<T2, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, plc1: PH, arg2: T2, arg3: T3,
		                    arg4: T4): Function1<T1, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, arg2: T2, arg3: T3,
		                    arg4: T4): Function0<R>;
		// catch-all
	...
	interface PartialRight {
		...
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>): Function4<T1, T2, T3, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, plc2: PH, plc3: PH,
		                    plc4: PH): Function3<T2, T3, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg2: T2, plc3: PH,
		                    plc4: PH): Function3<T1, T3, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, arg2: T2, plc3: PH,
		                    plc4: PH): Function2<T3, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg3: T3, plc4: PH): Function3<T1, T2, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, plc2: PH, arg3: T3,
		                    plc4: PH): Function2<T2, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg2: T2, arg3: T3,
		                    plc4: PH): Function2<T1, T4, R>;
		<T1, T2, T3, T4, R>(func: Function4<T1, T2, T3, T4, R>, arg1: T1, arg2: T2, arg3: T3,
		                    plc4: PH): Function1<T4, R>;
	...
	interface LoDashStatic {
		 ...
		 * @return Returns the new function.
		 */
		restParam<TResult extends Function>(func: Function,
		                                    start?: number): TResult;

		/**
		 * @see _.restParam
		 */
		restParam<TResult extends Function, TFunc extends Function>(func: TFunc,
		                                                            start?: number): TResult;
	}
	interface LoDashImplicitObjectWrapper<T> {
		/**
	...
	interface LoDashStatic {
		 ...
		 * @see _.max
		 */
		max<T>(collection: List<T> | Dictionary<T>,
		       iteratee?: string,
		       thisArg?: any): T;
		 ...
		 * @see _.max
		 */
		max<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.max
		 */
		max(iteratee?: ListIterator<T, any>,
		    thisArg?: any): T;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.max
		 */
		max<T>(iteratee?: ListIterator<T, any> | DictionaryIterator<T, any>,
		       thisArg?: any): T;

		/**
		 * @see _.max
		 */
		max<T>(iteratee?: string,
		       thisArg?: any): T;
	...
	interface LoDashStatic {
		 ...
		 * @see _.min
		 */
		min<T>(collection: List<T> | Dictionary<T>,
		       iteratee?: string,
		       thisArg?: any): T;
		 ...
		 * @see _.min
		 */
		min<TObject extends {}, T>(collection: List<T> | Dictionary<T>,
		                           whereValue?: TObject): T;
	}
	interface LoDashImplicitArrayWrapper<T> {
		/**
		 * @see _.min
		 */
		min(iteratee?: ListIterator<T, any>,
		    thisArg?: any): T;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.min
		 */
		min<T>(iteratee?: ListIterator<T, any> | DictionaryIterator<T, any>,
		       thisArg?: any): T;

		/**
		 * @see _.min
		 */
		min<T>(iteratee?: string,
		       thisArg?: any): T;
	...
	interface LoDashStatic {
		 ...
		 * @see _.sum
		 */
		sum<T>(collection: List<number> | Dictionary<number>,
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.sum
		 **/
		sum<TValue>(iteratee: ListIterator<TValue, number> | DictionaryIterator<TValue, number>,
		            thisArg?: any): number;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.assign
		 */
		assign<TSource extends {}, TResult extends {}>(source: TSource,
		                                               customizer?: AssignCustomizer,
		                                               thisArg?: any): LoDashImplicitObjectWrapper<TResult>;
	...
	interface LoDashStatic {
		 ...
		 * @return Returns object.
		 */
		merge<TObject, TSource, TResult>(object: TObject,
		                                 source: TSource,
		 ...
		 * @see _.merge
		 */
		merge<TObject, TSource1, TSource2, TResult>(object: TObject,
		                                            source1: TSource1,
		                                            source2: TSource2,
		                                            customizer?: MergeCustomizer,
		                                            thisArg?: any): TResult;
		 ...
		 * @see _.merge
		 */
		merge<TObject, TSource1, TSource2, TSource3, TResult>(object: TObject,
		                                                      source1: TSource1,
		                                                      source2: TSource2,
		                                                      source3: TSource3,
		                                                      customizer?: MergeCustomizer,
		 ...
		 * @see _.merge
		 */
		merge<TObject, TSource1, TSource2, TSource3, TSource4, TResult>(object: TObject,
		                                                                source1: TSource1,
		                                                                source2: TSource2,
		                                                                source3: TSource3,
		                                                                source4: TSource4,
		 ...
		 * @see _.merge
		 */
		merge<TObject, TResult>(object: TObject,
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.merge
		 */
		merge<TSource, TResult>(source: TSource,
		                        customizer?: MergeCustomizer,
		                        thisArg?: any): LoDashImplicitObjectWrapper<TResult>;
		 ...
		 * @see _.merge
		 */
		merge<TSource1, TSource2, TResult>(source1: TSource1,
		                                   source2: TSource2,
		                                   customizer?: MergeCustomizer,
		                                   thisArg?: any): LoDashImplicitObjectWrapper<TResult>;
		 ...
		 * @see _.merge
		 */
		merge<TSource1, TSource2, TSource3, TResult>(source1: TSource1,
		                                             source2: TSource2,
		                                             source3: TSource3,
		                                             customizer?: MergeCustomizer,
		                                             thisArg?: any): LoDashImplicitObjectWrapper<TResult>;
		 ...
		 * @see _.merge
		 */
		merge<TSource1, TSource2, TSource3, TSource4, TResult>(source1: TSource1,
		                                                       source2: TSource2,
		                                                       source3: TSource3,
		                                                       source4: TSource4,
		                                                       customizer?: MergeCustomizer,
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.omit
		 **/
		omit<Omitted>(...keys: string[]): LoDashImplicitObjectWrapper<Omitted>;
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.pick
		 */
		pick<TResult extends Object>(...predicate: Array<string | number | boolean | Array<string | number | boolean>>): LoDashImplicitObjectWrapper<TResult>;
	}
	//_.result
	interface LoDashStatic {
		/**
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.set
		 */
		set<V>(path: StringRepresentable | StringRepresentable[],
		       value: V): LoDashImplicitObjectWrapper<T>;
	}
	interface LoDashExplicitObjectWrapper<T> {
		/**
		 * @see _.set
		 */
		set<V>(path: StringRepresentable | StringRepresentable[],
		       value: V): LoDashExplicitObjectWrapper<T>;
	}
	//_.transform
	interface LoDashStatic {
		/**
	...
	interface LoDashStatic {
		 ...
		 */
		trunc(string?: string,
		      options?: TruncOptions | number): string;
	}
	interface LoDashImplicitWrapper<T> {
		/**
		 * @see _.trunc
	...
	interface LoDashImplicitWrapper<T> {
		...
		times<TResult>(iteratee: (num: number) => TResult,
		               thisArgs?: any): LoDashImplicitArrayWrapper<TResult>;
	...
	interface LoDashExplicitWrapper<T> {
		 ...
		 */
		times<TResult>(iteratee: (num: number) => TResult,
		               thisArgs?: any): LoDashExplicitArrayWrapper<TResult>;
